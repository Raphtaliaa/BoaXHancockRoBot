![Hancock](https://telegra.ph/file/3dc42133b91105f43e06d.jpg)
# Boa Hancock Bot

A modular Telegram Python bot running on python3 with a sqlalchemy database.

Originally a Marie fork, Hancock evolved further and was built to be more robust and more dedicated to Anime Chats. 

Can be found on telegram as [BoaXHancockBot](https://t.me/BoaXHancockBot).

The Support group can be reached out to at [Hancock Support](https://t.me/BoaXHancockSupport), where you can ask for help about @BoaXHancockBot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [Hancock Updates](https://t.me/BoaXHancockUpdates) 
...
Note: This instruction set is just a copy-paste from Marie, note that [Hancock Support](https://t.me/OnePunchSupport) aims to handle support for @SaitamaRobot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [Hancock Support](https://t.me/BoaXHancockSupport)
...
Should any be missing kindly let us know at [Hancock Support](BoaXHancockSupport) or simply submit a pull request on the readme.
